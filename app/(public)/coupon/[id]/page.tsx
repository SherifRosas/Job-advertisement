    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-100">
          <h1 className="text-3xl font-bold text-center mb-2" dir="rtl">تم التقديم بنجاح!</h1>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-500 rounded-xl p-8 text-center shadow-lg">
              ...
              <h2 className="text-3xl font-bold text-green-700 mb-2" dir="rtl">تم قبول طلبك!</h2>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-8 rounded-xl border-2 border-gray-200 space-y-5">
            <h3 className="text-xl font-bold mb-6 text-center" dir="rtl">تفاصيل الكوبون</h3>
            <h3 className="text-lg font-semibold mb-6 text-center text-gray-600">Coupon Details</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-600 mb-1" dir="rtl">اسم المتقدم</p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-600 mb-1" dir="rtl">العلامة الأمنية</p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-600 mb-1" dir="rtl">حالة الطلب</p>
                <p className="font-semibold text-green-600" dir="rtl">مقبول</p>
          ...
          {appointment && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 p-8 rounded-xl shadow-lg">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-2" dir="rtl">موعد المقابلة</h3>
              ...
              <div className="bg-white p-6 rounded-lg space-y-4 border border-blue-200">
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-600 mb-1" dir="rtl">التاريخ</p>
                    <p className="font-bold text-lg">{new Date(appointment.date).toLocaleDateString('ar-EG', { 
                      weekday: 'long', 
                      year: 'numeric', 
                      month: 'long', 
                      day: 'numeric' 
                ...
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-600 mb-1" dir="rtl">الوقت</p>
                ...
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-gray-600 mb-2" dir="rtl">المكان</p>
                  <p className="font-bold text-lg mb-1" dir="rtl">{appointment.location}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
            ...
            >
              ...
              <span dir="rtl" className="block">طباعة الكوبون</span>
              <span className="text-sm">Print Coupon</span>
            </button>
            <button
              onClick={() => {
                // Copy coupon details to clipboard
            ...
            >
              ...
              <span dir="rtl" className="block">نسخ التفاصيل</span>
          ...
          <div className="mt-8 bg-green-50 border-2 border-green-200 p-6 rounded-xl text-center" dir="rtl">
            ...
            <p className="text-green-600 text-xs">
              Your application will be reviewed and you'll be notified via email
            </p>
          </div>
        </div>
      </div>
